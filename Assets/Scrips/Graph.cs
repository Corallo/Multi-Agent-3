...
namespace MyGraph {
	public class GraphNode {
		...
		public GraphNode(float _x, float _z) {
			x = _x;
			z = _z;
	...
	public class Graph {
		...
		public int addNode(GraphNode newGraphNode) {
			int id = size++;
			newGraphNode.setId(id);
			newGraphNode.setColor(0);
			nodes.Add(id, newGraphNode);
			adjList.Add(id, new List<int>());
			return id;
		}
		public int addNode(GraphNode newGraphNode, List<int> _adjList) {
			int id = size++;
			nodes.Add(id, newGraphNode);
			adjList.Add(id, _adjList);
			return id;
		}
		public GraphNode getNode(int _id) {
			return nodes[_id];
		}
		...
		public double computeAngle(GraphNode _A, GraphNode _B, GraphNode _C) {
        ...
        public GraphNode FindClosestNode(Vector3 target, Graph G) {

            GraphNode temp;
            GraphNode closest = nodes[0];//root
        ...
        public GraphNode FindClosestSafeNode(Vector3 target, Graph G) {
